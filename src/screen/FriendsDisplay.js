...
export default class FriendsDisplay extends PureComponent {
	...
	// 	console.log('x: ', nextState);
	// 	// console.log('x: ', nextState.selectedFriendMobile);
	// 	// console.log(this.state.selectedFriendMobile != nextState.selectedFriendMobile);
	// 	// if
	// 	return nextProps.item.selectedFriendMobile != nextState.selectedFriendMobile;
	// };
	...
	displayFriendMovieList = (item) => {
		...
		this.props.displayFriendMovieList(item);
	};
